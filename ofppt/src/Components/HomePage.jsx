...
const HomePage = ({ setPage, setSelectedModule }) => {
  ...
  return (
    <div className="containerhomepage">
      ...
      <button className="module" onClick={() => handleModuleClick('react')}>
      ...
      <button className="module" onClick={() => handleModuleClick('mysql')}>
      ...
      <button className="module" onClick={() => handleModuleClick('agile')}>
      ...
      <button className="module" onClick={() => handleModuleClick('laravel')}>
